_base_ = [
    '../_base_/datasets/remoteDataset.py', '../_base_/default_runtime.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint="/home1/users/chenzhenxiang02/mmsegmentation-main/weights/resnet50_v1c-2cccc1ad.pth")),
    decode_head=dict(
        type='MaskFormerHead',
