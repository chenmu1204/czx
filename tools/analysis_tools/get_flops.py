...
def parse_args():
    ...
    parser.add_argument('--config', default='/home1/users/chenzhenxiang02/mmsegmentation-main/configs/dpt/dpt_vit-b16_8xb2-160k_ade20k-512x512.py', help='train config file path')
    parser.add_argument(
        '--shape',
        type=int,
        nargs='+',
