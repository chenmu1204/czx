...
checkpoint_file = '/home1/users/chenzhenxiang02/mmsegmentation-main/weights/swin_tiny_patch4_window7_224_20220317-1cdeb081.pth'
crop_size = (
    512,
    512,
)
...
data_root = '/data3/chenzhenxiang/mydata/RSMI_Fine_3/'
...
launcher = 'none'
load_from = '/home1/users/chenzhenxiang02/mmsegmentation-main/work_dirs/RSMI_Fine_3-0828-swin-tiny-patch4-window7-in1k-pre_upernet_8xb2-160k_ade20k-512x512/iter_45000.pth'
log_level = 'INFO'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/home1/users/chenzhenxiang02/mmsegmentation-main/weights/swin_tiny_patch4_window7_224_20220317-1cdeb081.pth',
            type='Pretrained'),
        mlp_ratio=4,
